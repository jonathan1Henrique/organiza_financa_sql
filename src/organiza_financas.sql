CREATE SEQUENCE sq_despesas_diarias START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
CREATE TABLE despesas_diarias(
   id BIGINT NOT NULL DEFAULT NEXTVAL('sq_despesas_diarias'::regclass) CONSTRAINT despesas_diarias_pkey PRIMARY KEY,
